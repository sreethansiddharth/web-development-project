...
//   };
//   return (
//     <div className="quiz-card max-w-lg mx-auto">
//     <img 
...
//       <div className="quiz-card max-w-lg mx-auto" role="main" aria-label="Authentication"></div>
//       <h2 className="text-4xl font-bold text-gray-800 mb-3 text-center">Welcome to <span className="gradient-text">Quizly</span></h2>
//       <p1 className="text-lg text-gray-600 mb-8 text-center">Select an option to continue:</p1>      
//       {/* Auth mode toggle */}
...
//           <h3 className="text-2xl font-bold text-gray-800 mb-6 text-center bg-color:green ">Sign In</h3>
  ...
  return (
    <div className="quiz-card max-w-lg mx-auto" role="main" aria-label="Authentication">
      ...
      <div 
        ...
        className="animate-float"
        role="img"
        aria-label="Quizly Logo"
      >
        QUIZLY
      </div>
      
      <h1 className="text-4xl font-bold text-gray-800 mb-3 text-center">
        Welcome to <span style={{ background: 'linear-gradient(135deg, #EC265F, #26ECB4)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Quizly</span>
      </h1>
